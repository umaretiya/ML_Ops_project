...
class Pipeline(Thread):
    ...
    def __int__(self, config:Configuration):
        try:
    ...
    def start_data_transformation(self,data_ingestion_artifact,
        ...
        try:
            data_taansformation = DataTransformation(
                data_transformation_config=self.config.get_data_transformation_config(),
                data_ingestion_artifact=data_ingestion_artifact,
                data_validation_artifact=data_validation_artifact,
            )
            return data_taansformation.initiate_data_transformation() 
        except Exception as e:
            raise HousingException(e, sys) from e 
    ...
    def run_pipeline(self):
        try:
            ...
            Pipeline.experiment = Experiment(experiment_id=experiment_id,
                                            ...
                                            accuracy=None)
            logging.info(f"Pipeline experement: [{Pipeline.experiment}]")
