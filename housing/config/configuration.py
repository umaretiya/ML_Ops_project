...
from housing.entity.config_entity import (DataIngestionConfig,DataTransformationConfig,
                                          ...
                                          ModelPusherConfig,ModelEvaluationConfig,
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            ingested_train_dir = os.path.join(
                data_ingestion_artifact_dir,data_ingestion_info[DATA_INGESTION_TRAIN_DIR_KEY]
            )
    ...
    def get_model_trainer_config(self) ->ModelTrainerConfig:
        try:
            ...
            model_trainer_config = ModelTrainerConfig(
                train_model_file_path=trained_model_file_path,
